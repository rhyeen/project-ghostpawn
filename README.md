...
```
git clone https://github.com/rhyeen/project-ghostpawn
cd project-ghostpawn
npm install
npm start
```
...
For deployment, I use [Netlify](https://www.netlify.com/). Since this project does not have an Open Source license, you are not permitted to deploy the code to a public URL.
